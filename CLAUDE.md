...
- Soft-launch: сидер создаёт одну bootstrap-пару из `ALLOWED_USER_IDS` — бот работает
  для двоих без UI мэтчинга. Инвайты/мэтчинг включаются позже (Спринт 8) без миграции.
